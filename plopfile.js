  ...
  plop.setGenerator('rapid pinger', {
    ...
    actions: [
      ...
      },
      {
        type: 'append',
        path: 'src/renderer/redux/actions.js',
        pattern: '// PLOP SET_RESPONSE PROD PLACEHOLDER',
        separator: '\n',
        template: '{{#if_equal envKey "prod"}}[SERVICE_KEY.{{constantCase serviceKey}}]: SET_{{constantCase serviceKey}}_PROD_RESPONSE,{{/if_equal}}',
      },
      {
        type: 'append',
        path: 'src/renderer/redux/actions.js',
        pattern: '// PLOP SET_RESPONSE STAGE PLACEHOLDER',
        separator: '\n',
        template: '{{#if_equal envKey "prod"}}{{else}}[SERVICE_KEY.{{constantCase serviceKey}}]: SET_{{constantCase serviceKey}}_STAGE_RESPONSE,{{/if_equal}}',
      },
      {
        type: 'append',
        path: 'src/renderer/redux/actions.js',
        ...
        separator: '\n',
        template: '{{#if_equal envKey "prod"}}[SERVICE_KEY.{{constantCase serviceKey}}]: GET_INIT_PROD_{{constantCase serviceKey}}_DATA,{{/if_equal}}',
      },
      {
        type: 'append',
        path: 'src/renderer/redux/actions.js',
        ...
        separator: '\n',
        template: '{{#if_equal envKey "prod"}}{{else}}[SERVICE_KEY.{{constantCase serviceKey}}]: GET_INIT_STAGE_{{constantCase serviceKey}}_DATA,{{/if_equal}}',
      },
      {
        type: 'append',
        path: 'src/renderer/redux/actions.js',
        ...
        separator: '\n',
        template: '{{#if_equal envKey "prod"}}[SERVICE_KEY.{{constantCase serviceKey}}]: SET_INIT_PROD_{{constantCase serviceKey}}_DATA,{{/if_equal}}',
      },
      {
        type: 'append',
        path: 'src/renderer/redux/actions.js',
        ...
        separator: '\n',
        template: '{{#if_equal envKey "prod"}}{{else}}[SERVICE_KEY.{{constantCase serviceKey}}]: SET_INIT_STAGE_{{constantCase serviceKey}}_DATA,{{/if_equal}}',
      },
      {
        type: 'append',
        path: 'src/renderer/redux/actions.js',
        ...
        separator: '\n',
        template: '{{#if_equal envKey "prod"}}[SERVICE_KEY.{{constantCase serviceKey}}]: NOTIFY_{{constantCase serviceKey}}_PROD_CHANGES,{{/if_equal}}',
      },
      {
        type: 'append',
        path: 'src/renderer/redux/actions.js',
        ...
        separator: '\n',
        template: '{{#if_equal envKey "prod"}}{{else}}[SERVICE_KEY.{{constantCase serviceKey}}]: NOTIFY_{{constantCase serviceKey}}_STAGE_CHANGES,{{/if_equal}}',
      },
      // {
      //   type: 'append',
